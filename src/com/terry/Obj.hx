...
class Obj {		
	...
	public static var TRIGGER:Int = 1;
	public static var DAMAGE:Int = 2;
	...
	public static function createtrigger(xp:Int, yp:Int, trig:String = "null"):Void {
		createblock(1, xp * Gfx.tiles[Gfx.currenttileset].width, yp * Gfx.tiles[Gfx.currenttileset].height, Gfx.tiles[Gfx.currenttileset].width, Gfx.tiles[Gfx.currenttileset].height, trig); 
	}

	public static function createdoor(xp:Int, yp:Int, trigs:String, destx:Int, desty:Int, dname:String=""):Void {
		createblock(3, xp * Gfx.tiles[Gfx.currenttileset].width, yp * Gfx.tiles[Gfx.currenttileset].height, Gfx.tiles[Gfx.currenttileset].width, Gfx.tiles[Gfx.currenttileset].height, trigs, destx, desty, dname); 
	}
	...
	public static function checkwall():Bool{
		...
		tempx = getgridpoint(Std.int(temprect.x), Gfx.tiles[Gfx.currenttileset].width); tempy = getgridpoint(Std.int(temprect.y), Gfx.tiles[Gfx.currenttileset].height);
		tempw = getgridpoint(Std.int(temprect.x + temprect.width - 1), Gfx.tiles[Gfx.currenttileset].width); temph = getgridpoint(Std.int(temprect.y + temprect.height - 1), Gfx.tiles[Gfx.currenttileset].height);
		...
		if (temprect.height >= 12) {
			tpy1 = getgridpoint(Std.int(temprect.y + 6), Gfx.tiles[Gfx.currenttileset].height);
			if (World.collide(tempx, tpy1)) return true;
			if (World.collide(tempw, tpy1)) return true;
			if (temprect.height >= 18) {
				tpy1 = getgridpoint(Std.int(temprect.y + 12), Gfx.tiles[Gfx.currenttileset].height);
				if (World.collide(tempx, tpy1)) return true;
				if (World.collide(tempw, tpy1)) return true;
				if (temprect.height >= 24) {
					tpy1 = getgridpoint(Std.int(temprect.y + 18), Gfx.tiles[Gfx.currenttileset].height);
					if (World.collide(tempx, tpy1)) return true;
					if (World.collide(tempw, tpy1)) return true;
				}
			}
		...
		if (temprect.width >= 12) {
			tpx1 = getgridpoint(Std.int(temprect.x + 6), Gfx.tiles[Gfx.currenttileset].width);
